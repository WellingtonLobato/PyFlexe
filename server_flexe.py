...
def serve(ip_server, n_clients, dataset, n_classes, model_name, non_iid):
    print("+-------------------------------+")
    print("|       GRPC Server Start!      |")
    print("+-------------------------------+")
    print("Server IP address: " + ip_server)
    print("Number of Clients: " + str(n_clients))
    print("Dataset: " + dataset)
    print("Number of Classes: " + str(n_classes))
    print("Type of Model: " + model_name)
    print("Non-IID? " + str(non_iid))
    print()
    ...
    flexe_pb2_grpc.add_FlexeServicer_to_server(StoreApp(n_clients, dataset, n_classes, model_name, non_iid), server)
...
if __name__ == '__main__':
    ...
    parser.add_option("-m", "--model",       		dest="model_name",         default='GENERIC', help="Model used for trainning",               metavar="STR")
    ...
    logging.basicConfig()
    serve(opt.ip_address, opt.n_clients, opt.dataset, opt.n_classes, opt.model_name, opt.non_iid)
